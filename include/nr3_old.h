...
#ifndef _USENRERRORCLASS_  //notice! ifNdef
...
//remove following line, conflict with FLENS, don't care where happens, just re-compute
//#define throw(message) throw(NRerror(message,__FILE__,__LINE__));

void NRcatch(NRerror err) {
	
	// the following line has been commented by S.Z.
...
#else   // never use NRvector probably... end #257
...
/* commented out by S.Z, upto line #490*/
